    ...
    r(function() {
        ...
        function o(t, e, a, o, s) {
            0 < e && n(), r("html, body").animate({
                ...
                r(".asgdc").hide(), "dtshcode" == t.type ? r("#dooplay_player_response").html('<div class="pframe">' + t.embed_url + "</div>") : r("#dooplay_player_response").html('<div class="pframe"><iframe class="metaframe rptss" src="/api/embed.html?link=' + t.embed_url + '" frameborder="0" scrolling="no" allow="autoplay; encrypted-media" allowfullscreen></iframe></div>'), r("#playeroptions").removeClass("onload"), 0 < e && (r("#playernotice").html(s), r("#playernotice").removeClass("flashit"))
            }, 1e3 * e)
        }
